...
const LoTrinh = () => {
  ...
  const fetchRoadmaps = useCallback(async () => {
    ...
    try {
      ...
      // Gọi API qua fetchClient - Back-end sẽ tự động lọc dữ liệu theo VaiTro
              ...
              <div className="row g-4 mb-5">
                {roadmaps.length > 0 ? (
                  roadmaps.map((roadmap) => {
                    // Logic xác định quyền sở hữu (chỉ người tạo mới được sửa/xóa)
